...
import { makeEllipse } from '../lib/element-factory';
import { useSceneStore } from '../store';
import type { ToolDescriptor } from './types';

export function createEllipseTool(): ToolDescriptor {
    ...
    return {
        ...
        onPointerDown(input) {
            ...
            store.pushHistory();
            const element = makeEllipse(input.worldX, input.worldY, store.styles);
            activeId = element.id;
            startX = input.worldX;
            startY = input.worldY;
